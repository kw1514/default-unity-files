...
- Always validate scripts after making changes
- Validation catches compilation errors immediately
- Use `/fix-script-errors` to automatically fix common issues
- Check console for full error details if validation fails
